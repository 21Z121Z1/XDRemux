...
from research.oppo_styles.public_pretraining import (
    DEFAULT_CATEGORIES,
...
def main() -> None:
    ...
    collect.add_argument("--curated-only", action="store_true", help="use only the seven revision-pinned sources")
    ...
    if args.command == "collect":
        result = collect_public_corpus(
            ...
            categories=() if args.curated_only else (args.categories or DEFAULT_CATEGORIES),
