...
class PerformanceDesignArchitectureTests(unittest.TestCase):
    ...
    def test_apple_main10_prefers_hardware_without_requiring_it(self) -> None:
        ...
        benchmark = self.source("scripts/performance/benchmark_apple_videotoolbox_primitive.py")
    ...
    def test_hdr_benchmarks_distinguish_source_family_and_output_profile(self) -> None:
        benchmark = self.source("scripts/performance/benchmark_rust_product.py")
        for case in (
            "hdr-lhdr-mono400",
            "hdr-uhdr-rgb444",
