...
APPLE_PROTOCOL_CLIENTS = tuple(
    ...
    for path in (
        "scripts/apple/check_apple_adapter_handshake.sh",
        "scripts/apple/check_rust_cli_apple_portrait.sh",
        "scripts/apple/check_rust_cli_oppo_portrait.py",
        "scripts/apple/check_rust_style_consumer.sh",
        "scripts/apple/build_apple_device_validation.sh",
        "scripts/performance/benchmark_apple_videotoolbox_primitive.py",
    )
)
