...
from research.oppo_styles.inference import (
    UniversalImageInput,
    candidate_state_resources,
)
...
class UniversalPhotographicStyleTrainingTests(unittest.TestCase):
    ...
    def test_candidate_state_resources_have_native_byte_lengths(self) -> None:
        ...
        resources = candidate_state_resources(image, prediction)
